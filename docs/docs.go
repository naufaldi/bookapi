        ...
        "/books": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Legacy search query (ILIKE)",
                        "name": "q",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Filter by language code (e.g. en, id)",
                        "name": "language",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Sort by (title, created_at, rating, year, relevance)",
                        "name": "sort",
                        "in": "query"
                    },
                    {
        ...
        "/users/{id}/{list}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "List name (WISHLIST, READING, FINISHED)",
                        "name": "list",
                        "in": "path",
                        "required": true
                    },
